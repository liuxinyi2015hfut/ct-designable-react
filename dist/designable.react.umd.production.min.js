(function (global, factory) {
  ...
  Designable.Core.GlobalRegistry.registerDesignerLocales(icons$1, panels, global$1, operations);
  ...
  ***************************************************************************** */
  ...
  var useValidNodeOffsetRect = function (node) {
      ...
      var rectRef = React.useRef(viewport.getValidNodeOffsetRect(node));
      var idleTaskRef = React.useRef(null);
      ...
      var compute = React.useCallback(function () {
          ...
          if (engine.cursor.status !== Designable.Core.CursorStatus.Normal &&
              engine.screen.status === Designable.Core.ScreenStatus.Normal)
              return;
      ...
      React.useEffect(function () {
          ...
          var requestIdleTask = function () {
              Designable.Shared.cancelIdle(idleTaskRef.current);
              idleTaskRef.current = Designable.Shared.requestIdle(function () {
                  compute();
                  requestIdleTask();
              });
          };
  ...
  */
  ...
  var FreeSelection = Formily.ReactiveReact.observer(function () {
      ...
      var createSelectionStyle = function () {
          ...
          var rect = Designable.Shared.calcRectByStartEndPoint(startDragPoint, currentPoint, viewport.scrollX - cursor.dragStartScrollOffset.scrollX, viewport.scrollY - cursor.dragStartScrollOffset.scrollY);
          var baseStyle = {
              position: 'absolute',
              top: 0,
              left: 0,
      ...
      if (cursor.status !== Designable.Core.CursorStatus.Dragging ||
          cursor.type !== Designable.Core.CursorType.Selection)
          return null;
  ...
  var Cover = Formily.ReactiveReact.observer(function () {
      ...
      var renderDropCover = function () {
          ...
          if (!viewportDragon.closestNode ||
              ...
              viewportDragon.closestDirection !== Designable.Core.ClosestPosition.Inner)
              return null;
  ...
  var DesignerToolsWidget = Formily.ReactiveReact.observer(function (props) {
      ...
      var renderCursorController = function () {
          ...
          if (!props.use.includes('CURSOR'))
              return null;
          return (React.createElement(Antd.Button.Group, { size: "small", style: { marginRight: 20 } },
              React.createElement(Antd.Button, { size: "small", disabled: cursor.type === Designable.Core.CursorType.Move, onClick: function () {
                      cursor.setType(Designable.Core.CursorType.Move);
                  } },
                  React.createElement(IconWidget, { infer: "Move" })),
  ...
  var OutlineTreeNode = Formily.ReactiveReact.observer(function (_a) {
      ...
      React.useEffect(function () {
          return engine.subscribeTo(Designable.Core.DragMoveEvent, function () {
              ...
              if (!ref.current)
                  return;
              if (closestNodeId === id && closestDirection === Designable.Core.ClosestPosition.Inner) {
      ...
      React.useEffect(function () {
          return Formily.Reactive.autorun(function () {
              ...
              if (cursor.status === Designable.Core.CursorStatus.Dragging && ((_a = outlineDragon === null || outlineDragon === void 0 ? void 0 : outlineDragon.dragNodes) === null || _a === void 0 ? void 0 : _a.length)) {
                  if (ref.current.classList.contains('selected')) {
                      ref.current.classList.remove('selected');
                  }
              }
  ...
  var ResizeHandle = function (props) {
      ...
      return (React.createElement("div", __assign({}, props, { "data-designer-resize-handle": props.type, className: classnames(prefix, (_a = {},
  ...
  var useResizeEffect = function (container, content, engine) {
      ...
      engine.subscribeTo(Designable.Core.DragStartEvent, function (e) {
          ...
          if (target === null || target === void 0 ? void 0 : target.closest('*[data-designer-resize-handle]')) {
              ...
              engine.screen.setStatus(Designable.Core.ScreenStatus.Resizing);
          }
      });
      ...
      engine.subscribeTo(Designable.Core.DragStopEvent, function () {
          ...
          engine.screen.setStatus(Designable.Core.ScreenStatus.Normal);
          if (animationX) {
              animationX = animationX();
          }
          if (animationY) {
  ...
  var StudioPanelInternal = function (_a) {
      ...
      if (logo || actions) {
          return (React.createElement("div", __assign({}, props, { className: classnames(prefix + "-container", classNameBase) }),
              React.createElement("div", { className: prefix + '-header' },
