...
exports.SettingsPanel = reactive_react_1.observer(function (props) {
    var prefix = hooks_1.usePrefix('settings-panel');
    var workbench = hooks_1.useWorkbench();
    var _a = __read(react_1.useState(true), 2), innerVisible = _a[0], setInnerVisible = _a[1];
    var _b = __read(react_1.useState(false), 2), pinning = _b[0], setPinning = _b[1];
    var _c = __read(react_1.useState(true), 2), visible = _c[0], setVisible = _c[1];
    react_1.useEffect(function () {
        if (visible || workbench.type === 'DESIGNABLE') {
            if (!innerVisible) {
                shared_1.requestIdle(function () {
    ...
    return (react_1.default.createElement("div", { className: classnames_1.default(prefix, { pinning: pinning }) },
