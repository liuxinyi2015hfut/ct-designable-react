...
var StudioPanelInternal = function (_a) {
    ...
    var prefix = hooks_1.usePrefix('main-panel');
    var position = hooks_1.usePosition();
    var classNameBase = classnames_1.default('root', position, props.className);
    if (logo || actions) {
        return (react_1.default.createElement("div", __assign({}, props, { className: classnames_1.default(prefix + "-container", classNameBase) }),
    ...
    return (react_1.default.createElement("div", __assign({}, props, { className: classnames_1.default(prefix, classNameBase) }), props.children));
};
