...
var CompositePanel = function (props) {
    var _a;
    var _b, _c, _d;
    var prefix = hooks_1.usePrefix('composite-panel');
    var _e = __read(react_1.useState((_b = props.defaultActiveKey) !== null && _b !== void 0 ? _b : getDefaultKey(props.children)), 2), activeKey = _e[0], setActiveKey = _e[1];
    var activeKeyRef = react_1.useRef(null);
    var _f = __read(react_1.useState((_c = props.defaultPinning) !== null && _c !== void 0 ? _c : false), 2), pinning = _f[0], setPinning = _f[1];
    var _g = __read(react_1.useState((_d = props.defaultOpen) !== null && _d !== void 0 ? _d : true), 2), visible = _g[0], setVisible = _g[1];
    ...
    react_1.useEffect(function () {
        if (shared_1.isValid(props.activeKey)) {
    ...
    var renderContent = function () {
        if (!content || !visible)
            return;
        return (react_1.default.createElement("div", { className: classnames_1.default(prefix + '-tabs-content', {
                pinning: pinning,
            }) },
    ...
    return (react_1.default.createElement("div", { className: classnames_1.default(prefix, (_a = {},
        ...
        react_1.default.createElement("div", { className: prefix + '-tabs' }, items.map(function (item, index) {
            ...
            return (react_1.default.createElement(Comp, { className: classnames_1.default(prefix + '-tabs-pane', {
