...
var MobileSimulator = function (props) {
    var prefix = hooks_1.usePrefix('mobile-simulator');
    return (react_1.default.createElement("div", __assign({}, props, { className: classnames_1.default(prefix, props.className) }),
