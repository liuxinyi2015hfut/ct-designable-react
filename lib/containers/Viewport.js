...
var Viewport = function (_a) {
    ...
    var _b = __read(react_1.useState(false), 2), loaded = _b[0], setLoaded = _b[1];
    var prefix = hooks_1.usePrefix('viewport');
    var viewport = hooks_1.useViewport();
    var ref = react_1.useRef();
    var viewportRef = react_1.useRef();
    var isFrameRef = react_1.useRef(false);
    ...
    return (react_1.default.createElement("div", __assign({}, props, { ref: ref, className: classnames_1.default(prefix, props.className), style: __assign({ opacity: !loaded ? 0 : 1, overflow: isFrameRef.current ? 'hidden' : 'overlay' }, props.style) }),
        props.children,
