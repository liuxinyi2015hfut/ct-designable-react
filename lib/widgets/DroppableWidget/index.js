...
require("./styles.less");
exports.DroppableWidget = reactive_react_1.observer(function (_a) {
    var _b;
    ...
    var currentNode = hooks_1.useTreeNode();
    var nodeId = hooks_1.useNodeIdProps(node);
    ...
    var prefixCls = hooks_1.usePrefix('droppable');
    return (react_1.default.createElement("div", __assign({}, nodeId, { className: className, style: style }),
        hasChildren ? (props.children) : placeholder ? (react_1.default.createElement("div", { style: { height: height }, className: prefixCls + "-placeholder" },
