...
require("./styles.less");
exports.DesignerToolsWidget = reactive_react_1.observer(function (props) {
    var screen = hooks_1.useScreen();
    var cursor = hooks_1.useCursor();
    var workbench = hooks_1.useWorkbench();
    var history = hooks_1.useHistory();
    var sizeRef = react_1.useRef({});
    var prefix = hooks_1.usePrefix('designer-tools');
    ...
    var renderCursorController = function () {
        ...
        if (!props.use.includes('CURSOR'))
            return null;
        return (react_1.default.createElement(antd_1.Button.Group, { size: "small", style: { marginRight: 20 } },
            react_1.default.createElement(antd_1.Button, { size: "small", disabled: cursor.type === core_1.CursorType.Move, onClick: function () {
    ...
    return (react_1.default.createElement("div", { style: props.style, className: classnames_1.default(prefix, props.className) },
