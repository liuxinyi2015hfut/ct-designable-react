...
exports.ViewToolsWidget = reactive_react_1.observer(function (_a) {
    var use = _a.use, style = _a.style, className = _a.className;
    var workbench = hooks_1.useWorkbench();
    var prefix = hooks_1.usePrefix('view-tools');
    return (react_1.default.createElement(antd_1.Button.Group, { style: style, className: classnames_1.default(prefix, className) },
