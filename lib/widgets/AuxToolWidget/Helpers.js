...
var Helpers = function (_a) {
    ...
    var prefix = hooks_1.usePrefix('aux-helpers');
    var designer = hooks_1.useDesigner();
    var viewport = hooks_1.useViewport();
    var unmountRef = react_1.useRef(false);
    var ref = react_1.useRef();
    var _c = __read(react_1.useState('top-right'), 2), position = _c[0], setPosition = _c[1];
    react_1.useLayoutEffect(function () {
        ...
        update();
        return reactive_1.reaction(function () { return [
            viewport.width,
            viewport.height,
            viewport.scrollX,
            viewport.scrollY,
    ...
    if (!nodeRect || !node)
        return null;
    return (react_1.default.createElement("div", { className: classnames_1.default(prefix, (_b = {},
            _b[position] = true,
            _b)), ref: ref },
        react_1.default.createElement("div", { className: classnames_1.default(prefix + '-content') },
