...
var SelectionBox = function (props) {
    ...
    var prefix = hooks_1.usePrefix('aux-selection-box');
    var innerPrefix = hooks_1.usePrefix('aux-selection-box-inner');
    var nodeRect = hooks_1.useValidNodeOffsetRect(props.node);
...
exports.Selection = reactive_react_1.observer(function () {
