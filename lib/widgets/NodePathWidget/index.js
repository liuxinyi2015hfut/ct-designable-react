...
require("./styles.less");
exports.NodePathWidget = reactive_react_1.observer(function (props) {
    var _a;
    var selected = hooks_1.useCurrentNode(props.workspaceId);
    var selection = hooks_1.useSelection(props.workspaceId);
    var hover = hooks_1.useHover(props.workspaceId);
    var prefix = hooks_1.usePrefix('node-path');
    if (!selected)
