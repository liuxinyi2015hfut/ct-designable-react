...
require("./styles.less");
exports.TreeNodeWidget = reactive_react_1.observer(function (props) {
    var _a, _b;
    var designer = hooks_1.useDesigner((_b = (_a = props.node) === null || _a === void 0 ? void 0 : _a.designerProps) === null || _b === void 0 ? void 0 : _b.effects);
    ...
    var renderComponent = function () {
        ...
        if (Component) {
            ...
            return react_1.default.createElement.apply(react_1.default, __spread([Component,
...
exports.ComponentTreeWidget = reactive_react_1.observer(function (props) {
    var _a, _b;
    var tree = hooks_1.useTree();
    var prefix = hooks_1.usePrefix('component-tree');
    ...
    return (react_1.default.createElement("div", __assign({ style: __assign(__assign({}, props.style), (_b = tree === null || tree === void 0 ? void 0 : tree.props) === null || _b === void 0 ? void 0 : _b.style), className: classnames_1.default(prefix, props.className) }, dataId),
