...
require("./styles.less");
exports.ResourceWidget = reactive_react_1.observer(function (props) {
    var prefix = hooks_1.usePrefix('resource');
    var _a = __read(react_1.useState(props.defaultExpand), 2), expand = _a[0], setExpand = _a[1];
    var renderNode = function (source) {
        ...
        return (react_1.default.createElement("div", { className: prefix + '-item', style: { gridColumnStart: "span " + (span || 1) }, key: node.id, "data-designer-source-id": node.id },
    ...
    var sources = props.sources.reduce(function (buf, source) {
        if (core_1.isResourceList(source)) {
            return buf.concat(source);
        }
        else if (core_1.isResourceHost(source)) {
    ...
    return (react_1.default.createElement("div", { className: classnames_1.default(prefix, props.className, {
            expand: expand,
        }) },
        ...
        react_1.default.createElement("div", { className: prefix + '-content-wrapper' },
            react_1.default.createElement("div", { className: prefix + '-content' },
                sources.map(shared_1.isFn(props.children) ? props.children : renderNode),
                remainItems ? (react_1.default.createElement("div", { className: prefix + '-item-remain', style: { gridColumnStart: "span " + (3 - remainItems) } })) : null))));
});
