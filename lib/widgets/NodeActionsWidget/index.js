...
require("./styles.less");
exports.NodeActionsWidget = reactive_react_1.observer(function (props) {
    var node = hooks_1.useTreeNode();
    var prefix = hooks_1.usePrefix('node-actions');
    var selected = hooks_1.useSelected();
    if (selected.indexOf(node.id) === -1 && props.activeShown)
        return null;
    return (react_1.default.createElement("div", { className: classnames_1.default(prefix, props.className), style: props.style },
...
exports.NodeActionsWidget.Action = function (_a) {
    ...
    var prefix = hooks_1.usePrefix('node-actions-item');
    return (react_1.default.createElement(antd_1.Typography.Link, __assign({}, props, { className: classnames_1.default(props.className, prefix), "data-click-stop-propagation": "true" }),
