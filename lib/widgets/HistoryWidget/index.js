...
require("./styles.less");
exports.HistoryWidget = reactive_react_1.observer(function () {
    ...
    var prefix = hooks_1.usePrefix('history');
    if (!currentWorkspace)
        return null;
    return (react_1.default.createElement("div", { className: prefix }, currentWorkspace.history.list().map(function (item, index) {
        ...
        return (react_1.default.createElement("div", { className: classnames_1.default(prefix + '-item', {
            ...
            react_1.default.createElement("span", { className: prefix + '-item-timestamp' },
                ' ',
                dateformat_1.default(item.timestamp, 'yy/mm/dd HH:MM:ss'))));
    })));
});
