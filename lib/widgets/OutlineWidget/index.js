...
exports.OutlineTreeWidget = reactive_react_1.observer(function (_a) {
    ...
    var prefix = hooks_1.usePrefix('outline-tree');
    ...
    var tree = hooks_1.useTree(workspaceId);
    var outline = hooks_1.useOutline(workspaceId);
    var outlineRef = react_1.useRef();
    ...
    return (react_1.default.createElement(context_1.NodeContext.Provider, { value: { renderActions: renderActions, renderTitle: renderTitle } },
        react_1.default.createElement("div", __assign({}, props, { className: classnames_1.default(prefix + '-container', className), style: style }),
